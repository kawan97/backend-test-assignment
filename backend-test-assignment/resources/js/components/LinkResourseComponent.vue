        ...
        <form class="col-6"  @submit.prevent="onSubmit">
            ...
            <div class="mb-3">
              ...
              <div class="mb-3 form-check">
                <input type="checkbox" class="form-check-input" value="1" name="linkNewTabCheck" id="linkNewTabCheck">
                <label class="form-check-label" for="linkNewTabCheck">Open in a new tab</label>
            </div>
            <button type="submit" class="btn btn-warning col-12">Upload Link</button>
        </form>
    </div>
</div>
</template>
